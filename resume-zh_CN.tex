...
\basicInfo{
  \begin{tabu}{ c r r }
   \multirow{2}{1in}{\name{赵炳}}\hspace{11em} &  &  \\
    & \email{zhoabingcn@hotmail.com} & \pbar{Java}{0.7} \\
    Java研发工程师& \phone{(+86) 182-2291-7001} & \pbar{Python}{0.5} \\
    数据分析工程师& \github[zhaobingcn]{https://github.com/zhaobingcn} & \pbar{Scala}{0.5} \\
...
\end{onehalfspacing}
\datedsubsection{\faBank \textbf{中国电子科技集团信息科学研究院} ，\faMapMarker 北京}{2016年4月 -- 2017年2月}
\role{SpringBoot-GraphProcessing}{前期项目，验证可行性，独自开发}
\vspace{-0.7em}
\begin{onehalfspacing}
